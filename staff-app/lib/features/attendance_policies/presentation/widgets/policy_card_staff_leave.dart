...
class PolicyCardStaffLeave extends StatefulWidget {
  const PolicyCardStaffLeave({
    super.key,
  ...
  static const List<int> presets = [10, 14, 18, 24, 30];

  @override
  State<PolicyCardStaffLeave> createState() => _PolicyCardStaffLeaveState();
}

class _PolicyCardStaffLeaveState extends State<PolicyCardStaffLeave> {
  ...
  @override
  void didUpdateWidget(covariant PolicyCardStaffLeave oldWidget) {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              children: PolicyCardStaffLeave.presets.map((l) {
          ...
          Row(
            children: [
              const Icon(Icons.info_outline, size: 12, color: Color(0xFF9333EA)),
              const SizedBox(width: 5),
              Expanded(
                child: Text(
                  'Permits up to ${widget.quotaDays} days of paid leaves per academic year for staff.',
                  style: TextStyle(
                    fontSize: 10,
                    color: isDark ? AppColors.textDarkMuted : AppColors.textLightMuted,
                  ),
