...
/// Ultra-Luxury Low-Profile Cascading Dropdown Card for Attendance.
/// Features side-by-side Course and Class selectors with zero text truncation.
            ...
            children: [
              ...
              Expanded(
                child: _buildCompactDropdown<CourseEntity>(
                  ...
                  items: courses,
                  itemLabel: (c) => c.localizedName(isRtl, context.currentLanguageCode, context),
                  onChanged: onCourseChanged,
                ),
              ),
              const SizedBox(width: 8),

              // 2. Class Dropdown (Right)
              Expanded(
